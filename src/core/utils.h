...
public:
	...
	static Vector3D reflect(const Vector3D& n, const Vector3D& i);
...
//    static Vector3D sumPerCanal(const Vector3D &v1, const Vector3D &v2);
	...
	static bool intersect(Ray r, const Vector3D& v0, const Vector3D& v1, const Vector3D& v2, Intersection& inter);
